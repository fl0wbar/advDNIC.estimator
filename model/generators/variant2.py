...
from model.generators.transforms.base import (
    AnalysisTransform,
    SynthesisTransform,
    HyperAnalysisTransform,
    HyperSynthesisTransformScale,
    HyperSynthesisTransformMean,
)
...
def generator(
    ...
    analysis_transform = AnalysisTransform(params.num_filters)
    synthesis_transform = SynthesisTransform(params.num_filters)
    hyper_analysis_transform = HyperAnalysisTransform(params.num_filters)
    hyper_synthesis_transform_scale = HyperSynthesisTransformScale(params.num_filters)
    hyper_synthesis_transform_mean = HyperSynthesisTransformMean(params.num_filters)
    ...
    if is_training:
        ...
        with tf.variable_scope("generator"):
            ...
            sigma = hyper_synthesis_transform_scale(z_tilde)
            mu = hyper_synthesis_transform_mean(z_tilde)
            scale_table = np.exp(
                np.linspace(
        ...
        if decompression:
            ...
            with tf.variable_scope("generator"):
                ...
                sigma = hyper_synthesis_transform_scale(z_hat)
                mu = hyper_synthesis_transform_mean(z_hat)
