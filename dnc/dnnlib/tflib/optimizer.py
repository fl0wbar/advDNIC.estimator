...
class Optimizer:
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._dev_ls_var = OrderedDict()  # device => variable (log2 of loss scaling
        # factor)
    ...
    def register_gradients(
        ...
        """Register the gradients of the given loss function with respect to the given
        variables.
    ...
    def get_loss_scaling_var(self, device: str) -> Union[tf.Variable, None]:
        """Get or create variable representing log2 of the current dynamic loss scaling
        factor."""
        if not self.use_loss_scaling:
            return None
